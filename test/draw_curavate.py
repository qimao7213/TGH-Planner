...
# 主程序
filenames = [
        #  'data/curv_geo.txt', 'data/curv_init.txt', 
        #  'data/curv_opt.txt', 'data/curv_yaw_constr.txt', 
         'data/curv_mid.txt', 'data/curv_perception.txt', 
        #  'data/curv_reall.txt',
	    #  'data/yaw_plan.txt', 'data/yaw_dot_plan.txt', 'data/yaw_dot_desire_plan.txt'
        #  , 'data/yaw_opt.txt'
        #  , 'data/yaw_dot_opt_plan.txt', 'data/yaw_wpt.txt'
         ]
labels = [
