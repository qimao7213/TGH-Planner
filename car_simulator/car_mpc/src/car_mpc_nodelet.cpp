...
class Nodelet : public nodelet::Nodelet {
 private:
  ...
  void mpcplan_timer_callback(const ros::TimerEvent& event) 
  {
    ...
    double t_cur = (time_now - start_time_).toSec() + dt_ + 0.05;
  ...
  void replanCallback(std_msgs::Empty msg) 
  {
    ...
    mpcPtr_->setTrajDuration(traj_duration_);
  }
  //清空内存
 ...
 public:
  void onInit(void) {
    ...
    nh.getParam("car_mpc/Diff_Model", Diff_Model);
