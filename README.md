...
Change the parameters of *map_offset_*_* to fit the coordinates between Rviz and Gazebo.
...
Set **fast_planner/plan_manage/launch/kino_algorithm.xml Line 127** to **true**, the latest optimized B-Spline Trajectories will be recored to **test/data**
