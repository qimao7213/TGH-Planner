...
# 主程序
filenames = [
            # '../bspline_data/w_yaw_constr.txt',
            '../bspline_data/angle_opt1.txt', '../bspline_data/angle_vel_opt1.txt',
            '../bspline_data/angle_opt2.txt', '../bspline_data/angle_vel_opt2.txt',
            '../bspline_data/angle_vel_constr.txt',
         ]
labels = [
